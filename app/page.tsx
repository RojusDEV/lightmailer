...
export default function Home() {
    return (
        <div className="relative min-h-screen">
            <Main />
            <div className="absolute inset-0 -z-10 bg-[linear-gradient(to_right,#73737320_1px,transparent_1px),linear-gradient(to_bottom,#73737320_1px,transparent_1px)] bg-[size:70px_70px]"></div>
            <CometGrid />
